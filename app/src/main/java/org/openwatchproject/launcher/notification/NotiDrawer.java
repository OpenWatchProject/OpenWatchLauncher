...
import org.openwatchproject.launcher.notification.view.DateTimeView;
import org.openwatchproject.launcher.notification.view.NotificationHeaderView;
...
public class NotiDrawer {
    ...
    private ArrayList<Notification.Action> mActions = new ArrayList<>(OpenWatchNotification.MAX_ACTION_BUTTONS);
